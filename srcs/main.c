...
void	conveyor_tex(t_tree *tree)
{
	...
	extract_tex(&tree->texture.img_P, &tree->texture.tex_P, "textures/mine_knight.xpm", tree);
	extract_tex(&tree->texture.img_C, &tree->texture.tex_C, "textures/mine_crystal.xpm", tree);
	...
	extract_tex(&tree->texture.img_V, &tree->texture.tex_V, "textures/victory.xpm", tree);
}
